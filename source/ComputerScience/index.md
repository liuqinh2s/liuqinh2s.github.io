...
>我看过许多虚拟世界话题的电影，比如：黑客帝国、异次元骇客、楚门的世界、盗梦空间。
...
1. 三重环积分无法显示：$\unicode{x2230}$（我这里用了特殊的技巧才将它显示出来），显示为：$\oiiint$，详情参考：[mathjax常用公式记录](../2018/04/30/mathjax常用公式记录/#2)
2. markdown和mathjax的冲突，详情参见：[Hexo+Markdown+MathJax搭建个人博客](../2018/04/25/Hexo+Markdown+MathJax搭建个人博客/#3.2.3)
