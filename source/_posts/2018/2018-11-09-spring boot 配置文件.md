...
1. 在默认配置文件中使用：`spring.profiles.active=dev`
...
.m2/repository/org/springframework/boot/spring-boot-autoconfigure/2.1.0.RELEASE/spring-boot-autoconfigure-2.1.0.RELEASE.jar!/META-INF/spring.factories中有对这个类名的描述：
